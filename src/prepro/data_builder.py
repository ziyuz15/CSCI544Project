...
def split_data(all_files, train_frac=0.8, validation_frac=0.1, test_frac=0.1):

    assert train_frac + validation_frac + test_frac == 1, "The fractions must sum up to 1."
    ...
    validate_end = train_end + int(len(all_files) * validation_frac)
...
def format_to_lines(args):
    ...
    train_files, valid_files, test_files = split_data(all_files)
